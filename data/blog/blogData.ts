export const blogPosts = [
  {
    ...
    content: [
      ...
      {
        type: "text",
        text: `In recent years, men’s fashion in Northern Nigeria has embraced slimmer cuts, lighter fabrics, 
        and intricate embroidery. While traditional garments like *Kaftan* remain dominant, they are now designed with 
        tailored fitting and modern designs. Designers such as Mudi Africa and Habib Couture have introduced smart casual 
        variations, combining native styles with Western fashion elements like trousers and blazers. Accessories such as 
        caps (Hula), loafers, and designer wristwatches have also gained popularity, with a growing emphasis on neat grooming 
        and minimalism.`,
      },
      {
        type: "subheading",
      ...
      {
        type: "text",
        text: `Women’s fashion in Northern Nigeria has experienced even more dynamic changes. From 2018 to 2025, younger women have gradually moved from conservative all-black Abayas to more colorful, body-conscious, and fashion-forward styles. Fabrics like “Ankara” have seen a massive revival, tailored into fashionable gowns, skirts, and jumpsuits. Even traditional wedding attire, such as the “Kampala” or “George wrapper”, is now fused with lace and sequins for a contemporary appeal.
Modern northern women also incorporate stylish hijabs, turbans, and modest fashion brands into their wardrobes, giving rise to a powerful *modest fashion movement*. Social media platforms like Instagram and TikTok have played a crucial role in spreading these trends across states like Kaduna, Kano, Gombe, and Maiduguri.`,
      ...
      {
        type: "text",
        text: `The dress making industry in Northern Nigeria has undergone remarkable growth. Between 2018 and 2025, fashion designers and tailors have evolved from basic sewing services to full-fledged fashion entrepreneurs. They now offer custom fittings, bridal services, online bookings, and even fashion training academies.
Technology has played a vital role — fashion houses use mobile apps, WhatsApp, and social media to showcase their work, interact with clients, and market their designs. Local fashion events, like Kano Fashion Week and Arewa Fashion Show, have become platforms to showcase indigenous creativity to a global audience.`,
      ...
      {
        type: "text",
        text: `Islam, being the dominant religion in Northern Nigeria, continues to shape how fashion is perceived. The fusion of religious values with modern trends has created a unique dress culture known as “modest fashion.” This has given rise to female Muslim fashion influencers who wear trendy yet modest outfits, thus encouraging young women to remain stylish without compromising their beliefs.
Designers now create Abayas, Hijabs, and long dresses in luxurious fabrics, bright colors, and flattering cuts — a trend that has gained both local and international attention.`,
      ...
      {
        type: "text",
        text: `Despite the progress, there are challenges. Power supply issues, cost of materials, and access to high-quality sewing equipment remain hurdles for many tailors and fashion businesses. Insecurity in parts of the North has also hindered the growth of fashion schools and cross-state fashion events.
Additionally, global inflation and the impact of the COVID-19 pandemic (2020–2022) disrupted fashion events, supply chains, and consumer purchasing power. However, many fashion entrepreneurs have shown resilience by adapting to online platforms and simplifying their production methods.`,
      ...
      {
        type: "text",
        text: `Looking ahead, the fashion and dress making industry in Northern Nigeria is poised for even greater growth. With the youth population embracing creativity, digital marketing, and cultural pride, the region will likely produce more internationally recognized designers.
Investment in fashion education, textile production, and government support for small-scale tailors could further unlock potential in this vibrant industry. Sustainable fashion, recycling, and eco-friendly materials may also shape the next phase of modern dressing in the North.`,
  ...
  {
    title: "How to Care for Your RamyJoo Outfits",
    author: "RamyJoo Fashion Lab",
    category: "Style Tips",
    image: "/images/blogs/clothing-care.jpg",
    excerpt:
      "Luxury deserves love. Here's how to care for your premium RamyJoo pieces to make them last longer, shine brighter, and remain elegant season after season.",
    content: [
      {
        type: "text",
        text: `From Ankara to lace and chiffon, proper care extends the life of your clothes. Here are essential care tips for RamyJoo outfits:`,
      },
      {
        type: "text",
        text: `1. Hand wash delicate fabrics like lace or bridal mesh to avoid tearing.`,
      },
      {
        type: "text",
        text: `2. Use mild detergent and cold water for Ankara outfits to preserve their rich colors.`,
      },
      {
        type: "text",
        text: `3. Avoid sun-drying heavily padded gowns. Shade-drying protects structure and fabric.`,
      },
      {
        type: "text",
        text: `4. Steam instead of iron where possible, especially on delicate embroidery or pleats.`,
      },
      {
        type: "text",
        text: `5. Store in garment bags to protect from dust and maintain freshness.`,
      },
    ],
    date: new Date(),
  },
  ...
  },
  {
    ...
    excerpt:
      "Your scent is part of your outfit. Learn how to pair the right RamyJoo fragrance with your style, mood, and occasion — so you always show up unforgettable.",
    content: [
      {
        type: "text",
        text: `Looking good is great. Smelling good? Even better. Here’s how to match fragrance with fashion:`,
      },
      {
        type: "text",
        text: `1. **Elegant Gowns** – Pair with a floral scent like *Bloom Her* for graceful entrances.`,
      },
      {
        type: "text",
        text: `2. **Boss Babe Looks (Pantsuits, Bougie fits)** – Choose *Noir Essence* for bold confidence.`,
      },
      {
        type: "text",
        text: `3. **Cultural Ankara or Lace Pieces** – Try *Oud Heritage*, deep and traditional.`,
      },
      {
        type: "text",
        text: `4. **Casual Wear** – Use *Luxe Air*, light and refreshing, for brunch or market runs.`,
      },
      {
        type: "text",
        text: `Your scent becomes part of your presence. Choose wisely, wear boldly.`,
      },
    ],
    date: new Date(),
  }
